...
### Понятие *Свойства* проекта

Ключевым понятием организации иерархии является понятие *свойства* проекта.

Каждое *свойство* проекта  определяет некоторую функциональность, которая может быть поддержана в проекте - то, для чего
на английском используется термин *feature*.

Каждому свойству ставится в соответствие уникальный *тег* (в более общем случае - уникальный набор равноправных синонимов).
