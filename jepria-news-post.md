...
что позволило бы оптимальным образом поддерживать продукты разных классов: корпоративный web, публичные сайты, мобильный
native,мобильный web и т.д.
...
Сегодня, 18 декабря 2019 года, [база знаний *SoftSpiders*](https://github.com/softspider?tab=repositories) имеет 38 прототипов.
