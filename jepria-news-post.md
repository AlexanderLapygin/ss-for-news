...
Просматривается минимум два варианта использования прототипных решений в *Jepria*:
- Разработка иерархии прототипов разных по набору свойств и сложности решений для существующего *Jepria*
- Разработка нового, условного *Jepria 20.0*, в виде иерархии прототипных решений 
...
инструментов, ориентированных на монолит, таких как фреймворк *Jepria*, как генератор *Jepria Toolkit*, создавать и
использовать инструменты, ориентированные на иерархию прототипов.  
